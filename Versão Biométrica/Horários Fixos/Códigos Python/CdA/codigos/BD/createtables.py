...
c.execute("create table membros (nome varchar(80), dig_pos varchar(3), id int, presenca int)")
con.commit()

# Cria o log da porta
c.execute("create table logsporta (nome varchar(80), dig_pos varchar(3), InOut int, dia varchar(5), mes varchar(5), ano varchar(5), hora varchar(5), min varchar(5), seg varchar(5))")
con.commit()
