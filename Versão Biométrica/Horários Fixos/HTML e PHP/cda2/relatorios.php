...
<html lang="pt-br">
	...
	<?php
		...
		if($day2 == 0){
			...
			$query = "SELECT nome, inout, dia, mes, ano, hora, min, seg FROM logsporta WHERE dia = '" . $day1 . "' AND mes = '" . $month1 . "' AND ano = '" . $year1 . "' ORDER BY ano, mes, dia, hora, min, seg";
		...
		echo "<tr><th>Nome</th><th>Entrada/Saída</th><th>Dia</th><th>Mês</th><th>Ano</th><th>Hora</th><th>Minuto</th><th>Segundo</th></tr>";
